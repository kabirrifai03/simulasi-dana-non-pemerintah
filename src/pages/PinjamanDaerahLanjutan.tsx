  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="ml-0 lg1100:ml-64 flex-1 flex flex-col">
        <Header name="Simulasi Risiko & Kelayakan Pinjaman Daerah" />
        <main className="px-4 sm:px-6 py-6 space-y-6">
          {/* Risiko */}
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow space-y-4">
              ...
              <button onClick={handleRisiko} className="bg-green-600 text-white px-4 py-2 rounded lg1100:w-auto">
                Hitung Risiko
              </button>
            </div>
          ...
          {/* Kelayakan Umum */}
            <h2 className="text-lg sm:text-xl font-bold">Cek Kelayakan Umum Pinjaman Daerah</h2>
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow space-y-6">
              ...
              <button onClick={handleUmum} className="bg-purple-600 text-white w-full sm:w-auto px-4 py-2 rounded lg1100:w-auto">
